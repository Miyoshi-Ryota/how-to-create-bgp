...
poweroff --> poweron : 電源ボタンの押下
poweroff --> poweroff : 音量増加ボタンの押下
poweroff --> poweroff : 音量減少ボタンの押下
poweron --> poweroff : 電源ボタンの押下
poweron --> poweron : 音量増加ボタンの押下
poweron --> poweron : 音量減少ボタンの押下
